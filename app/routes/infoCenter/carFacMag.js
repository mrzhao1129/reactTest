...
import { url_getCarFactory2, url_postCarFactory, url_putCarFactory, url_delCarFactory, } from '../../utils/config/api';
...
class carFacMag extends Component {
  render() {
    return (
      <div className="sysMag">
        <div className="search-form">
          <Row gutter={24}>
            <Col  {...ColProps}>
              <Input placeholder="车厂名称" onChange={e => this.queryForm.orgName = e.target.value}/>
            </Col>
        ...
        >
          {[
            {label: '车厂名称', type: <Input />, key: 'orgName', init: this.getEditItem('org_name')}, 
            {label: '车厂地址', type: <Input />, key: 'orgAddress', init: this.getEditItem('org_address')}, 
        ...
        >
          {[
            ...
            {label: '车厂编号', init: this.getEditItem('id')}, 
            {label: '经度', init: this.getEditItem('lng')}, 
            {label: '纬度', init: this.getEditItem('lat')}, 
            {label: '车厂地址', init: this.getEditItem('org_address')}, 
            {label: '父节点ID', init: this.getEditItem('parent_id')}, 
